  ...
  return (
    <Layout>
      <div className="border-b border-gray-200 pb-5 my-4">
        <h3 className="text-2xl font-bold leading-6 text-gray-900 ">Pic Cards</h3>
      </div>
      <br />
      {/*<!-- *************************Main-Section******************************** -->*/}
      <section className=" grid grid-cols-1 md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-0 min-[1025px]:grid-cols-2 min-[1260px]:grid-cols-4">
              ...
              <div className="p-3">
                <div className="bg-white shadow-xl rounded-xl px-6 grid grid-cols-2">
                  ...
                  <div className="flex justify-end">
                    <img src="/Image1.jpeg" alt="" className="w-[119px]  mt-5 lg:mt-8 " />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="p-3">
                <div className="bg-white shadow-lg rounded-xl px-6 grid grid-cols-2">
                  ...
                  <div className="flex justify-end">
                    <img
                      src="/Image4.jpeg" alt="" className=" md:w-[85px] lg:w-[90px] w-[110px]  mt-5 ml-3 " />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div >
              <div className="p-3">
                <div className="bg-white shadow-lg rounded-xl px-6 grid grid-cols-2">
                  ...
                  <div className="flex justify-end">
                    <img
                      src="/Image3.jpeg" alt="" className="w-[105px] md:w-[95px] mt-5 ml-3  " />
                  </div>
                </div>
              </div>
            </div>
        ...
        <section >
          <div className="container xl:py-5 mx-auto">
            <div>
              <div className="p-3">
                <div className="bg-white shadow-lg rounded-xl px-4 grid grid-cols-2">
                  <div className="py-3">
                    <h2 className="text-lg text-gray-500 font-semibold mt-2">Total Orders</h2>
                    <h3
                    ...
                    <br />
                    <div className="lg:flex lg:flex-row">
                      <h5 className="text-3xl text-gray-500 font-medium mt-9 lg:-ml-2 ">
                        4.25k
                      </h5>
                  ...
                  <div className="flex justify-end">
                    <img
                      src="/Image2.jpeg" alt="" className="w-[90px]  mt-4 ml-3" />
                  </div>
                </div>
              </div>
            </div>
